...
MODEL_PATH = 'E:\\GLM-4\\ZhipuAI\\glm-4-9b-chat'
# MODEL_PATH = 'E:\\GLM-4\\ZhipuAI\\glm-4-9b-chat-1m'
...
model = AutoModelForCausalLM.from_pretrained(MODEL_PATH,
                                             ...
                                             quantization_config=nf4_config).eval()

# model = AutoPeftModelForCausalLM.from_pretrained(
# MODEL_PATH, trust_remote_code=True, device_map='auto',load_in_4bit=True
# )
